...
<head>
    ...
    .markdown-content h4, .markdown-content h5, .markdown-content h6 {
        ...
        padding-bottom: 0.3em; border-bottom: 1px solid #d0d7de;
    }
    ...
    .markdown-content table { display: block; width: max-content; max-width: 100%; overflow: auto; border-spacing: 0; border-collapse: collapse; border: 1px solid #d0d7de; border-radius: 6px; }
    ...
    /*
      NOTE: The specific list and blockquote styles for RTL/LTR are kept below the general
      .markdown-content[data-direction] rules to ensure proper margin/padding/border overrides.
    */
    #sidebarTitles li {
        display: flex;
        align-items: center; /* Align checkbox, title, and context menu trigger vertically */
    ...
    /* REMOVED: #documentMovementButtons fixed positioning */
